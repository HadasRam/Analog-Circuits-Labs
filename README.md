...
- **Lab 7 – Current Mirror**
  ...
  - Vds–Vdsat saturation analysis  
  - Influence of channel-length modulation  
  - Small-signal output resistance and mirror gain  
  - Virtuoso simulations validating theoretical equations

- **Lab 8 – Common Source Amplifier**  
  - Common-source with resistive load  
  - Common-source with diode-connected load  
  - DC sweep for optimal bias point  
  - gm extraction and theoretical gain verification  
  - AC simulation from 10 Hz to 10 GHz  
  - High-pass filter behavior (R1–C1)  
  - Transient analysis for different Vin amplitudes  
  - Saturation checks using Vds–Vdsat  
